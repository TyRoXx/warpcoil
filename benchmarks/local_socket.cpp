...
namespace
{
    ...
    void RequestAndResponseOverLocalSocket(benchmark::State &state)
    {
        ...
        async_binary_integer_function_server<decltype(server_impl), ip::tcp::socket, ip::tcp::socket> server(
        ...
        async_binary_integer_function_client<ip::tcp::socket, ip::tcp::socket> client(client_writer, client_splitter);
