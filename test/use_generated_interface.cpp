...
template <class Argument, class ExpectedResult, class ExpectedRequest,
          class Response>
void generic_test_serialization_client(
    ExpectedResult (test_interface::*call)(Argument), Argument argument,
...
BOOST_AUTO_TEST_CASE(serialization_client_no_result_no_parameter)
{
	generic_test_serialization_client(
	    ...
	    std::array<std::uint8_t, 1 + 22>{
	        {22, 'n', 'o', '_', 'r', 'e', 's', 'u', 'l', 't', '_', 'n', 'o',
	         '_', 'p', 'a', 'r', 'a', 'm', 'e', 't', 'e', 'r'}},
...
{
	generic_test_serialization_client(
	    &test_interface::two_parameters,
	    std::tuple<std::uint64_t, std::uint64_t>(2, 3), std::uint64_t(6),
	    std::array<std::uint8_t, 1 + 14 + (2 * 8)>{
	        {14, 't', 'w', 'o', '_', 'p', 'a', 'r', 'a', 'm', 'e', 't', 'e',
	         'r', 's', 0, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0, 3}},
...
{
	generic_test_serialization_client(
	    &test_interface::two_results, std::uint64_t(6),
	    std::tuple<std::uint64_t, std::uint64_t>(6, 7),
	    std::array<std::uint8_t, 1 + 11 + 8>{{11, 't', 'w', 'o', '_', 'r', 'e',
	                                          's', 'u', 'l', 't', 's', 0, 0, 0,
	                                          0, 0, 0, 0, 6}},
	    std::array<std::uint8_t, 2 * 8>{
...
{
	generic_test_serialization_client(
	    &test_interface::vectors, std::vector<std::uint64_t>{4, 5},
	    std::vector<std::uint64_t>{5, 4},
	    std::array<std::uint8_t, 1 + 7 + (3 * 8)>{
	        {7, 'v', 'e', 'c', 't', 'o', 'r', 's', 0, 0, 0, 0, 0, 0, 0, 2, 0, 0,
	         0, 0, 0, 0, 0, 4, 0, 0, 0, 0, 0, 0, 0, 5}},
	    std::array<std::uint8_t, 3 * 8>{{0, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0, 0, 0,
