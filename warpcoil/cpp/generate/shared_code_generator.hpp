            ...
            void require_structure(types::structure const &required)
            {
                ...
                block(m_code, m_indentation,
                      [&](indentation_level const in_warpcoil)
                      {
                          ...
                          block(m_code, in_warpcoil,
                                [&](indentation_level const in_cpp)
                                {
                                    start_line(m_code, in_cpp, "template <> struct structure_parser<");
                                    warpcoil::cpp::generate_name_for_structure(m_code, required);
                                        ...
                                        block(m_code, in_cpp,
                                              [&](indentation_level const in_struct)
                                              {
                                                  ...
                                                  start_line(
                                                      ...
                                                      "{ return "
                                                      "parse_complete<result_type>{result_type{}, "
                                    ...
                                    {
                                        Si::append(m_code, "> : basic_tuple_parser<structure_parser<");
                                        warpcoil::cpp::generate_name_for_structure(m_code, required);
                                        Si::append(m_code, ">, ");
                                        warpcoil::cpp::generate_name_for_structure(m_code, required);
                                        for (types::structure::element const &element : required.elements)
                                        ...
                                        block(m_code, in_cpp,
                                              [&](indentation_level const in_struct)
                                              {
                                                  ...
                                                  for (types::structure::element const &element : required.elements)
                                                  {
                                                      ...
                                                      warpcoil::cpp::generate_name_for_structure(m_code, required);
                                                      Si::append(m_code,
                                                                 " &result, std::integral_constant<std::size_t, ");
                                                      ...
                                                      block(m_code, in_struct,
                                                            ...
                                                            {
                                                                start_line(m_code, in_get, "return result.",
                                                                           element.name, ";\n");
                                                            },
                                                            "\n");
                                                      ++index;
