...
int main(int argc, char **argv)
{
    ...
    auto interfaces_writer = Si::make_container_sink(interfaces);
    {
        ...
        parameters.elements.emplace_back(types::integer());
        definition.add_method("evaluate", types::integer())("argument",
    ...
    {
        types::interface_definition definition;
        definition.add_method("no_result_no_parameter", Si::to_unique(types::tuple()))(
            "argument", Si::to_unique(types::tuple()));
        {
            types::tuple results;
            results.elements.emplace_back(types::integer());
            results.elements.emplace_back(types::integer());
            definition.add_method("two_results",
                                  Si::to_unique(std::move(results)))("argument", types::integer());
        }

        {
            ...
            parameters.elements.emplace_back(types::integer());
            parameters.elements.emplace_back(types::integer());
            definition.add_method("two_parameters", types::integer())(
                "argument", Si::to_unique(std::move(parameters)));
        }

        definition.add_method("vectors",
        ...
        definition.add_method(
            "vectors_256", Si::to_unique(types::vector{types::integer{0, 255}, types::integer()}))(
        ...
        definition.add_method("utf8", types::utf8{types::integer{0, 255}})(
            "argument", types::utf8{types::integer{0, 255}});
        definition.add_method("atypical_int", types::integer{1, 1000})("argument",
                                                                       types::integer{1, 1000});
        ...
        definition.add_method(
            "variant", Si::to_unique(types::variant{warpcoil::make_vector<types::type>(
        ...
        definition.add_method("structure",
                              Si::to_unique(types::structure{make_vector<types::structure::element>(
    ...
    {
        types::interface_definition definition;
        definition.add_method("make_directory", Si::to_unique(types::tuple()))(
            "path", types::utf8{types::integer{0, 0xffff}});
        definition.add_method("remove", Si::to_unique(types::tuple()))(
            "path", types::utf8{types::integer{0, 0xffff}});
        indentation_level const top_level;
        cpp::generate_serializable_interface(interfaces_writer, shared, top_level,
                                             Si::make_c_str_range("directory"), definition);
    }
    {
        types::interface_definition definition;
        definition.add_method(
            "read", Si::to_unique(types::vector{types::integer(), types::integer(0, 255)}));
        indentation_level const top_level;
        cpp::generate_serializable_interface(interfaces_writer, shared, top_level,
                                             Si::make_c_str_range("reader"), definition);
    }
    {
        types::interface_definition definition;
        ...
        indentation_level const top_level;
        cpp::generate_serializable_interface(interfaces_writer, shared, top_level,
                                             Si::make_c_str_range("writer"), definition);
    }
